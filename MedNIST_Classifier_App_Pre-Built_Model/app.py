...
class App(Application):
    ...
    def compose(self):
        # init_app_context parses argv, so -i/-o/-m on the command line override the
        # HOLOSCAN_* environment variables. The trained-model app used AppContext({}),
        # which only reads the environment.
